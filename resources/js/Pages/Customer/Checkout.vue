                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        >
                            ...
                            >
                                ...
                                <span
                                    class="bg-gradient-to-r from-gray-700 to-gray-900 bg-clip-text text-transparent"
                                    >📍 Bản đồ giao hàng</span
                                >
                            </h3>

                            <div
                                class="h-96 rounded-[2rem] overflow-hidden border-2 border-orange-200 relative shadow-inner bg-gradient-to-br from-gray-50 to-white"
                            >
                                <div
                                    id="checkout-map"
                                    class="w-full h-full"
                                ></div>
                                <div
                                    class="absolute top-4 left-4 bg-white/95 backdrop-blur-xl rounded-xl p-4 shadow-2xl border border-white/20"
                                >
                                    <p
                                        class="text-sm font-black text-gray-700 mb-2 flex items-center gap-2"
                                    >
                                        📍
                                        <span
                                    ...
                                    <div
                                        class="text-[11px] text-gray-600 leading-tight space-y-1"
                                    >
                                        ...
                                        <p>
                                            • Kéo thả marker để điều chỉnh chính
                                            xác
                                        </p>
                                    </div>
                                </div>
                            ...
                            <p class="text-xs text-gray-500 mt-4">
                                {{
                                    mapMessage ||
                                    "Bản đồ hiển thị khu vực Đà Nẵng. Nhập địa chỉ hoặc click để chọn vị trí giao hàng."
                                }}
                            </p>
                        </div>
                                ...
                                <div
                                    ...
                                    :class="
                                        form.payment_method === 'vnpay'
                                            ? 'border-blue-400 bg-gradient-to-r from-blue-50 to-blue-50 shadow-lg scale-105'
                                            : 'border-gray-200 hover:border-blue-300 hover:shadow-md'
                                    "
                                    class="cursor-pointer border-2 p-4 rounded-2xl flex items-center gap-4 transition-all duration-300 group transform hover:scale-[1.02]"
                                >
                                    <div
                                        class="w-12 h-12 bg-gradient-to-r from-blue-400 to-blue-500 rounded-xl shadow-lg flex items-center justify-center text-2xl group-hover:scale-110 transition-transform"
                                    >
                                        💳
                                    </div>
                                    <span
                                        class="font-black text-sm text-gray-700 uppercase tracking-tight group-hover:text-blue-600 transition-colors"
                    ...
                    >
                        ...
                        <div class="space-y-4">
                            ...
                            <div
                                ...
                                class="rounded-3xl border-2 border-green-300 bg-gradient-to-r from-green-50 to-green-100 p-4 text-sm text-green-700 shadow-lg"
                            >
                                🎉 Áp dụng voucher
                                <span
                                    class="font-black bg-gradient-to-r from-green-600 to-green-700 bg-clip-text text-transparent"
                            ...
                            <div
                                v-else
                                class="rounded-3xl border border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100 p-4 text-sm text-gray-600 shadow-inner"
                            >
                                🎁 Chọn voucher để nhận khuyến mãi khi thanh
                                toán.
                            </div>
                        </div>
                    </div>
